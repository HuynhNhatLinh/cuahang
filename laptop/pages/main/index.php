<!-- phần code của anh Huy hay sủi -->
                <div class="main-slider">
                    ...
                    <script>
                        ...
                        setTimeout(carousel, 1000); // Thay đổi ảnh trang bìa mỗi 1s thôi đấy ggwp
                        }
                    </script>
                    <div class="main-content">
                    
                        <div class="content-section">
                            <h2 class="hoanglamheader">Trang chủ</h2>
                    ...
                    <!-- phần code của anh Vũ Hoàng Lâm -->
                    <div id="hoanglam">
                        <h2 class="hoanglamheader">Báo tin tức công nghệ hôm nay</h2>
                        <div class="journal">
                            <?php
                    ...
                    <!-- kết thúc code anh Vũ Hoàng Lâm bú liếm-->