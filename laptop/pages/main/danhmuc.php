...
<?php
    if(isset($_GET['trang'])){ //khi inset trang
        ...
        $begin = ($page*4)-4;   // khi số khác thì lấy số trang nhân với 4 và trừ 4 sản phẩn trang trước vd đang lấy là mỗi trang 4 sp
    }
    $sql_pro = "SELECT * FROM tbl_sanpham WHERE tbl_sanpham.id_danhmuc = '$_GET[id]' AND tinhtrang=1 ORDER BY id_sanpham DESC LIMIT $begin,4"; //lấy tất cả 4 sản phẩm dựa vào id 
...
?>
        ...
        <div class="content-paging">
            <?php   
                ...
                $trang = ceil($row_count/4);//chia cho 4 này là lấy ví dụ mỗi trang có 4 sản phẩm
                //echo $trang;
            ?>
