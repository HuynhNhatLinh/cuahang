...
<?php
    if(isset($_GET['trang'])){ //khi inset trang
        ...
        $begin = ($page*8)-8;   // khi số khác thì lấy số trang nhân với 8 và trừ đi 8 sản phẩn trang trước vd đang lấy là mỗi trang 8 sp
    }
...
?>
        ...
        <div class="content-paging">
            <?php   
                ...
                $trang = ceil($row_count/8);//chia cho 8 này là lấy ví dụ mỗi trang có 8 sản phẩm
                // echo $trang;
            ?>
